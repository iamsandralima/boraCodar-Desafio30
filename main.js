...
async function getMoreInfo(id) {
  const options = {
    ...
    headers: {
      ...
      Authorization: 'Bearer  eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIyZGIzNDc2MzFkMDBmNzg5NzdlZDY4NjdjNTI4NzQxMiIsInN1YiI6IjY0Y2MwNTI1ZTA0ZDhhMDEzYTc1MDY4NSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.JY3eh2C04e2rAth2G_bl-bjhgUrCZ0_gVtrj5NecU3M'
    }
  };
...
function createMovieLayout({
  ...
  <div class="info">
    <div class="duration">
      <img src="./assets/Clock.png" alt="ícone relógio">
      <span>${time}</span>
    </div>

    <div class="year">
      <img src="./assets/CalendarBlank.png" alt="ícone Calendário">
      <span>${year}</span>
    </div>
  ...
  <button onclick="watch(event)" data-id="${id}">
    <img src="./assets/play.png" alt="botão Play">
...
function minutesToHourMinutesAndSeconds(minutes) {
 ...
 async function start() {
  // Pegar as Sugestões de filmes API
  ...
  // Organizar dados para substituir o conteúdo
    const props = {
      id: info.id,
      title: info.title,
